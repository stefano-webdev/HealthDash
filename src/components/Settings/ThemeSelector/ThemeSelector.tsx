...
function ThemeSelector() {
    ...
    if (savedData.settings?.theme) {
        initialTheme = themeLangEN[savedData.settings.theme as "light" | "dark"];
    } else {
        initialTheme = "Chiaro";
    }
    ...
    return (
        <div id="themeSelectorCont">
            <p>Tema</p>
            <div id="buttonThemeCont" className="dropdownThemeCont">
                ...
                <div className={`themeDropdownCont ${openMenu === 'open' ? "fadeDownChoices" : ""}`}>
                    <div onClick={() => handleTheme("Chiaro")}>
