        ...
        <div id="roleSelectorCont">
            ...
            <div id="buttonRoleCont" className="dropdownRoleCont selectorBtnCont">
                ...
                <div id="dropdownRole" className={`choicesDropdownCont ${openMenu === 'open' ? "fadeDownChoices" : ""}`}>
                    <button onClick={() => handleRole("Admin")} type="button" tabIndex={openMenu ? 0 : -1}>
                    ...
                    <button onClick={() => handleRole("Medico")} type="button" tabIndex={openMenu ? 0 : -1}>
                    ...
                    <button onClick={() => handleRole("Infermiere")} type="button" tabIndex={openMenu ? 0 : -1}>
