...
function Footer() {
    return (
        <footer>
            ...
            <p>Progetto realizzato con React, React router e TypeScript</p>

            <div id="githubCont" aria-label="Link al progetto GitHub">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
                    <path d="M244.8 8C106.1 8 0 113.3 0 252c0 110.9 
            ...
            <a href="https://github.com/stefano-webdev/HealthDash" target="_blank"
                aria-label="Vai al progetto GitHub">
                github.com/stefano-webdev/HealthDash
            </a>
        </footer>
    );
}
