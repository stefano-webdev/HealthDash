...
const rawData: Record<string, { revenue: number; expenses: number }> = {
    ...
    apr: { revenue: 12637814.9, expenses: 10238472.66 },
    ...
    ago: { revenue: 4283519.66, expenses: 4527184.2 },
...
function monthlyData() {
    ...
    const allData = monthsOrder.map((m) => {
        const balance = rawData[m].revenue - rawData[m].expenses;
        cumulative += balance;
        return {
