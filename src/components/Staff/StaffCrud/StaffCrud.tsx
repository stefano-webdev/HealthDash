...
function StaffCrud({ id, ...rest }: StaffCrudProps) {
    // È undefined per i nuovi dipendenti creati
        ...
        <>
            <div id='staffCrudCont' className='boxStyle'>
                ...
                <div id='staffCrudActionsCont'>
                    <button type="button" aria-label="Aggiungi personale" onClick={() => setShowCreate(prev => !prev)}>
                    ...
                    <button type="button" aria-label="Modifica personale">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
                    ...
                    <button type="button" aria-label="Elimina personale">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
            ...
            {showCreate && <StaffCreate close={() => setShowCreate(prev => !prev)} props={rest} />}
        </>
    );
}
