...
function Prescriptions({ selectedId }: { selectedId: number | null }) {
    ...
    return (
        <div id="prescriptionsCont" className="boxStyle">
            <div className='titleBox'>
                ...
                <h3 className='box'>Prescrizioni</h3>
            </div>

            <div id="prescriptionDetailsCont">
                <p><strong>Medicinale:</strong> <em>{patient?.prescriptions.medication}</em></p>
                <p><strong>Frequenza:</strong> <em>{patient?.prescriptions.frequency}</em></p>
            </div>
        </div>
    );
}
